...
public enum L10n {
    ...
    private static let zhTable: [String: String] = [
        ...
        "settings.about.privacy": "ccgauge-bar 默认零网络请求，从不上传，无遥测。\n所有外网请求都需要你主动点击：「检查更新」、本地 dashboard 不可用时打开官网、以及本页的 GitHub / Issues / Privacy 三个外链。",
    ...
    private static let enTable: [String: String] = [
        ...
        "settings.about.privacy": "ccgauge-bar makes zero network requests by default — no telemetry, no uploads.\nEvery outbound request is user-triggered: Check for updates, the dashboard fallback to the website, or the GitHub / Issues / Privacy links on this page.",
        "settings.about.github": "GitHub",
        "settings.about.issues": "Issues",
        "settings.about.privacy_link": "Privacy",
